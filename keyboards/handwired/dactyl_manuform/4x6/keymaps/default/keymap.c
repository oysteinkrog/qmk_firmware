...
[_L0] = LAYOUT( \
     ...
     KC_LSFT , KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,                         KC_K,   KC_M,KC_COMM, KC_DOT,KC_SLSH,KC_RSFT,   \
                    KC_LBRC,ALT_DEL,L1_BSPC, L2_ESC,MO(_L3),      L3_DEL , KC_ENT, KC_SPC,KC_RALT, KC_EQL,                   \
                                            KC_LGUI,_______,      KC_INS , KC_RALT
),
/*
 * L1: Numbers and FN
 * ,-----------------------------------------------.                     ,-----------------------------------------------.
 ...
 */
[_L1] = LAYOUT(
    ALT_TAB,_______,_______,_______,_______,_______,                      _______,   KC_7,   KC_8,   KC_9,_______,_______,
    _______,_______,_______,_______,_______,_______,                      _______,   KC_4,   KC_5,   KC_6,_______,_______,
    _______,_______,_______,_______,_______,KC_LGUI,                      KC_RGUI,   KC_1,   KC_2,   KC_3,_______,_______,
