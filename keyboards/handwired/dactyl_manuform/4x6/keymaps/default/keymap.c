...
[_L2] = LAYOUT(
    ...
    _______,_______,  KC_F4,  KC_F5,  KC_F6, KC_F11,                      KC_COMM,   KC_4,   KC_5,   KC_6,KC_MINS,_______,
    _______,_______,  KC_F1,  KC_F2,  KC_F3, KC_F12,                       KC_DOT,   KC_1,   KC_2,   KC_3   ,KC_0,_______,
                    _______,_______,_______,_______,_______,      _______,_______,_______,_______,_______,
 ...
 * |-------+-------+-------+-------+-------+-------|                     |-------+-------+-------+-------+-------+-------|
 * |       |       | MLEFT | MDOWN | MRIGHT|  MB1  |                     |  HOME | LEFT  | DOWN  | RIGHT |  END  | VOLDN |
 * |-------+-------+-------+-------+-------+-------|                     |-------+-------+-------+-------+-------+-------|
 * |       |       |       |       |       |  MB2  |                     |       |       |       |       |       |  MUTE |
 * `-------+-------+-------+-------+-------+-------+-------.     ,-------+-------+-------+-------+-------+-------+-------'
 *                 | RESET |       |       |       |       |     |       |       |       |       | RESET |
