 ...
 * `-------+-------+-------+-------+-------+-------+-------.     ,-------+-------+-------+-------+-------+-------+-------'
 *                 |   L3  |  LALT |L2_BSPC| L1_ESC|   L3  |     |   L3  | L1_SPC| L2_ENT|  RALT |   '   |
 *                 `-------+-------+-------+-------+-------+     +-------+-------+-------+-------+-------'
 *                                         |  LGUI |  INS  |     |  DEL  | RGUI  |
 *                                         `-------+-------'     `-------+-------'
 */
...
[_L0] = LAYOUT( \
     ...
     KC_LSFT , KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,                         KC_K,   KC_M,KC_COMM, KC_DOT,KC_SLSH,KC_RSFT,
                         L3,KC_LALT,L2_BSPC, L1_ESC,     L3,         L3  , L1_SPC, L2_ENT, KC_RALT,KC_QUOT,
                                            KC_LGUI,  KC_INS,      KC_DEL,KC_RGUI
),
/*
 * L1: Symbols
 * ,-----------------------------------------------.                     ,-----------------------------------------------.
...
[_L1] = LAYOUT(
    ...
    _______,KC_HASH,KC_DLR, KC_LPRN,KC_RPRN, KC_GRV,                      _______,KC_PLUS,KC_MINS,KC_SLSH,KC_ASTR,KC_PERC,
 ...
 * L2: Numbers and FN
 * ,-----------------------------------------------.                     ,-----------------------------------------------.
 * |ALT_TAB|       |  F7   |  F8   |  F9   |  F10  |                     |   =   |   7   |   8   |   9   |       |  NLCK |
 * |-------+-------+-------+-------+-------+-------|                     |-------+-------+-------+-------+-------+-------|
 * |       |       |  F4   |  F5   |  F6   |  F11  |                     |   +   |   4   |   5   |   6   |   ,   |       |
 * |-------+-------+-------+-------+-------+-------+                     +-------+-------+-------+-------+-------+-------|
 * |       |       |  F1   |  F2   |  F3   |  F12  |                     |   -   |   1   |   2   |   3   |   .   |       |
 ...
 */
[_L2] = LAYOUT(
    _______,_______,  KC_F7,  KC_F8,  KC_F9, KC_F10,                       KC_EQL,   KC_7,   KC_8,   KC_9,_______,KC_NLCK,
    _______,_______,  KC_F4,  KC_F5,  KC_F6, KC_F11,                      KC_PLUS,   KC_4,   KC_5,   KC_6,KC_COMM,_______,
    _______,_______,  KC_F1,  KC_F2,  KC_F3, KC_F12,                      KC_MINS,   KC_1,   KC_2,   KC_3,KC_DOT ,_______,
